        ...
        <div class="header-right">
            <div class="header-user-con">
                ...
                <div class="btn-fullscreen" @click="handleFullScreen">
                    <el-tooltip effect="dark" :content="fullscreen?`Quit Full Screen`:`Full Screen`" placement="bottom">
                        <i class="el-icon-rank"></i>
                    </el-tooltip>
                </div>
                <!-- 消息中心 -->
                <!-- <div class="btn-bell">
                    <el-tooltip effect="dark" :content="message?`${message} Unread Messages`:`Message Center`" placement="bottom">
                        <router-link to="/tabs">
...
<script>
    ...
    export default {
        ...
        computed:{
            username(){
                let username = sessionStorage.getItem('auth.user_name');
